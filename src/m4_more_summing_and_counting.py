...
def run_test_count_cosines_from():
    ...
    # Test 3:
    expected = 10
    answer = count_cosines_from(0, 9, -100)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)
    # Test 4:
    expected = 0
    answer = count_cosines_from(0, 500, 100)
...
def run_test_sum_unit_fractions_from():
    ...
    # -------------------------------------------------------------------------
    #Test 2:
    expected = 0.111111  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(9, 9)
